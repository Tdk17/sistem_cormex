...
class ClientFormOptions {
  ...
  factory ClientFormOptions.fromMap(Map<String, dynamic> map) {
    return ClientFormOptions(
      fiscalExceptions:
          _mapList(map['fiscalExceptions']).map(ClientOption.fromMap).toList(),
...
class ClientDetail {
  ...
  factory ClientDetail.fromMap(Map<String, dynamic> map) {
    ...
    return ClientDetail(
      ...
      additionalAddresses: _mapList(map['additionalAddresses'])
          ...
          .toList(),
      contacts: _mapList(map['contacts']).map(ClientContact.fromMap).toList(),
    );
  }
  ...
  Map<String, dynamic> toRequest() {
    return {
      ...
      'additionalAddresses':
          additionalAddresses.map((item) => item.toRequest()).toList(),
...
class ClientAddress {
  ...
  factory ClientAddress.fromMap(
    ...
    return ClientAddress(
      ...
      district:
          _string(map['district'], fallback: _string(map['neighborhood'])),
      city: _string(map['city']),
      state: _string(map['state']),
